...
ActiveRecord::Schema.define(version: 2019_12_03_221201) do
  ...
  create_table "moves", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["fight_id"], name: "index_moves_on_fight_id"
  end
  ...
  create_table "weapons", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["fight_id"], name: "index_weapons_on_fight_id"
  end

  add_foreign_key "characters", "fights"
  add_foreign_key "fights", "users"
  add_foreign_key "moves", "fights"
